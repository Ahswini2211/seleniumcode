...
class LoginPage():
    def __init__(self,driver):
        ...
        self.username_texbox_name  = "username"
    ...
    def enter_username(self,username):
        self.driver.find_element(By.NAME,self.username_texbox_name ).clear()
        self.driver.find_element(By.NAME,self.username_texbox_name).send_keys(username)
